...
@section('content')
            ...
            <div class="col-8">
                ...
                <main class="grid" id="first-show">
                    @foreach($pattern as $pat)
                        ...
                        @if($pat->player == true) <div id="pos{{$pat->id}}p"><img src="{{asset('images/tsolias.jpg')}}" style="overflow: hidden;display:inline;" /></div> @endif
                            @if($pat->math == true) <div id="pos{{$pat->id}}e"><a href="javascript:mathClicked({{$pat->matheq}}, {{$pat->id}});" class="manouri" style="color:firebrick;"><img src="{{asset('images/fesi.jpg')}}"></a></div> @endif
                        </b>
                @endforeach
                </main>
            </div>
            <div class="col-4">
                <div class="sticky-top" id="second-show">
                    <h2 class="text-center manouri">{{$username}}</h2>
                        ...
                        <button id="bl" onclick="selectedAction('L');" class="btn  btn-primary btn-lg"><i class="fa fa-arrow-left"></i></button>
                        <button id="br" onclick="selectedAction('R');" class="btn  btn-primary btn-lg"><i class="fa fa-arrow-right"></i></button>
                        <button id="bu" onclick="selectedAction('U');" class="btn  btn-primary btn-lg"><i class="fa fa-arrow-up"></i></button>
                        <button id="bd" onclick="selectedAction('D');" class="btn  btn-primary btn-lg"><i class="fa fa-arrow-down"></i></button>
    ...
    <div class="modal fade" id="successModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-success" id="exampleModalLabel">ΜΠΡΑΒΟ</h5>
                </div>
                <div class="modal-body">
                    <p>
                    ...
                    <h4>Ιστορία</h4>
                    <p>
                        <span id="storyModalTextSuccess"></span>
                    </p>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade" id="failModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-danger" id="exampleModalLabel">ΚΡΙΜΑ</h5>
                </div>
                <div class="modal-body">
                    <p>
                    ...
                    <h4>Ιστορία</h4>
                    <p>
                        <span id="storyModalTextFail"></span>
                    </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Πάμε!</button>
    ...
    <div class="modal fade" id="instructionsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        <b>Βήμα 1: </b> Πάτα σε ένα φέσι <img src="{{asset('images/fesi.jpg')}}" style="max-width: 30px;" /> για να δεις μία άσκηση<br/>
...
για να οδηγήσεις τον τσολιά <img src="{{asset('images/tsolias.jpg')}}" style="max-width: 30px;" /> στο στόχο <img src="{{asset('images/target.png')}}" style="max-width: 30px;" />. Έχεις μια ευκαιρία!<br/>
                    </p>
                    <p>
                        <b>Προσοχή!</b>
                        <ul>
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        function clearMoves() {
            ...
            $('#storyModalTextSuccess').html('');
            $('#storyModalTextFail').html('');
        ...
        function movePlayer(item, counter) {
            ...
            if(collision == 0) {
                $('#pos'+player+"p").remove();
                $('#pos'+todo).append('<div id="pos'+todo+'p"><img src="{{asset("images/tsolias.jpg")}}" style="overflow: hidden;display:inline;" /></div>');
                player = todo;
            } else {
        ...
        function mathClicked(mathId, eq) {
            ...
            $.ajax({
                ...
                success:function(data) {
                    ...
                    $('#storyModalTextSuccess').html(story);
                    $('#storyModalTextFail').html(story);
                    if(wrong.length > 0) {
                        //create buttons
