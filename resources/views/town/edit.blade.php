    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                @endif
                <form method="post" action="{{ route('towns.update', ['town' => $town]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="form-group">
                        <label for="townname">Ονομασία</label>
                            <input type="text" name="townname" class="form-control" id="townname" aria-describedby="townnamehelp" placeholder="Όνομα πόλης" value="{{ $town->name }}">
                        <small id="townnamehelp" class="form-text text-muted">όνομα πόλης (για το διαχειριστή</small>
                    </div>
                    <div class="form-group">
                        <label for="towntitle">Τίτλος</label>
                            <input type="text" name="towntitle" class="form-control" id="towntitle" aria-describedby="towntitlehelp" placeholder="Τίτλος" value="{{ $town->title }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="townslug" class="form-control" id="townslug" aria-describedby="townslughelp" placeholder="slug" value="{{ $town->slug }}">
                    ...
                    <div class="form-group">
                        <label for="towninfo">Πληροφορίες</label>
                            <textarea name="towninfo" class="form-control" id="towninfo" aria-describedby="towninfohelp">{{ $town->info }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="towncss" class="form-control" id="towncss" aria-describedby="towncsshelp">{{ $town->css }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select id="municipality" name="municipality" class="form-control">
                            @foreach($municipalities as $municipality)
                                <option value="{{ $municipality->id }}" @if($municipality->id == $town->municipality_id) selected="selected" @endif>{{$municipality->municipality}}</option>
                            @endforeach
                        </select>
                    </div>
