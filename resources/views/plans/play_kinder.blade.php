...
@section('content')
    <div class=" container-fluid">
        <div class="row justify-content-center">
            <div class="col-8">
                <h3 class="text-center">Πίνακας #{{ $plan->id }} <small>Πήγαινε σε όλες τις εικόνες χωρίς να χτυπήσεις το φράχτη ή το σκύλο</small></h3>
                <main class="grid">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="{{ route('start_plan_kinder', ['size'=> 4, 'level' => Auth::user()->level, 'diff' => sizeof($questions)]) }}" class="btn btn-success">Παίξε νέο</a>
                    <a href="{{ route('play_plan_kinder', ['plan'=> $plan->id]) }}" class="btn btn-warning">Παίξε το ίδιο</a>
                    <a href="{{ route('user_home') }}" class="btn btn-info">Αρχική</a>
                </div>
            </div>
        </div>
    </div>
